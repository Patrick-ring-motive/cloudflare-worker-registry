//@ts-nocheck
! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).Sval = t()
}(this, function() {
    "use strict";
    var D = Object.freeze({
            __proto__: null,
    ...
    function ee(e, t) {
        var r, i;
        r = e, i = t, z ? z(r, i) : r.__proto__ = i, e.prototype = $(t.prototype, {
            constructor: {
                value: e,
                writable: !0
            }
    ...
    function te(e, t, r) {
        ...
        var i = !1;
        try {
            i = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function() {}))
        } catch (e) {}
        return i ? Reflect.construct(t, r, Q(e).constructor) : t.apply(e, r)
    }

    function re(e) {
        if (!e.Object) throw 0;
        ie = H(i = e).filter(function(e) {
            return -1 === ["webkitStorageInfo", "GLOBAL", "root"].indexOf(e)
        })
    }
    ...
    for (var ne = $({}), se = 0; se < ie.length; se++) {
        var ae = ie[se];
        try {
            ne[ae] = i[ae]
        } catch (e) {}
    ...
    function a(e, t) {
        return e < 65 ? 36 === e : e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? 170 <= e && de.test(String.fromCharCode(e)) : !1 !== t && me(e, he)))
    }

    function ye(e, t) {
        return e < 48 ? 36 === e : e < 58 || !(e < 65) && (e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? 170 <= e && fe.test(String.fromCharCode(e)) : !1 !== t && (me(e, he) || me(e, ce)))))
    }
    ...
    function s(e, t) {
        return (t = void 0 === t ? {} : t).keyword = e, ge[e] = new r(e, t)
    }
    var g = {
            num: new r("num", e),
    ...
    function be(e, t, r) {
        ...
        for (var i = t; i < r; i++) {
            ...
            if (ve(n)) return i < r - 1 && 13 === n && 10 === e.charCodeAt(i + 1) ? i + 2 : i + 1
        }
        return -1
    }
    var xe = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
    ...
    function Ne(e) {
        ...
        return "latest" === i.ecmaVersion ? i.ecmaVersion = 1e8 : null == i.ecmaVersion ? (!Ve && "object" == typeof console && console.warn && (Ve = !0, console.warn("Since Acorn 8.0.0, options.ecmaVersion is required.\nDefaulting to 2020, but this will stop working in the future.")), i.ecmaVersion = 11) : 2015 <= i.ecmaVersion && (i.ecmaVersion -= 2009), null == i.allowReserved && (i.allowReserved = i.ecmaVersion < 5), e && null != e.allowHashBang || (i.allowHashBang = 14 <= i.ecmaVersion), _e(i.onToken) && (r = i.onToken, i.onToken = function $onToken(e) {
            ...
            a.locations && (e.loc = new Ae(this, n, s)), a.ranges && (e.range = [r, i]), o.push(e)
        })), i
    }
    ...
    function l(e, t, r) {
        this.options = e = Ne(e), this.sourceFile = e.sourceFile, this.keywords = Ce(ue[6 <= e.ecmaVersion ? 6 : "module" === e.sourceType ? "5module" : 5]);
        var i = "",
            i = (!0 !== e.allowReserved && (i = le[6 <= e.ecmaVersion ? 6 : 5 === e.ecmaVersion ? 5 : 3], "module" === e.sourceType) && (i += " await"), this.reservedWords = Ce(i), (i ? i + " " : "") + le.strict);
        this.reservedWordsStrict = Ce(i), this.reservedWordsStrictBind = Ce(i + " " + le.strictBind), this.input = String(t), this.containsEsc = !1, r ? (this.pos = r, this.lineStart = this.input.lastIndexOf("\n", r - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(o).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = g.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = !0, this.inModule = "module" === e.sourceType, this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = !1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = Object.create(null), 0 === this.pos && e.allowHashBang && "#!" === this.input.slice(0, 2) && this.skipLineComment(2), this.scopeStack = [], this.enterScope(1), this.regexpState = null, this.privateNameStack = []
    }
    ...
    var e = {
        ...
        e = (e.strictDirective = function $strictDirective(e) {
            ...
            for (;;) {
                ...
                var t, r, i, n = De.exec(this.input.slice(e));
                if (!n) return !1;
        ...
        Fe = (e.isLet = function $isLet(e) {
            if (!(this.options.ecmaVersion < 6) && this.isContextual("let")) {
                ...
                if (!e) {
                    ...
                    if (a(r, !0)) {
                        for (var i = t + 1; ye(r = this.input.charCodeAt(i), !0);) ++i;
            ...
            switch (this.isLet(e) && (s = g._var, i = "let"), s) {
                ...
                case g._export:
                case g._import:
                    if (10 < this.options.ecmaVersion && s === g._import) {
                        c.lastIndex = this.pos;
                    ...
                    return this.options.allowImportExportEverywhere || (t || this.raise(this.start, "'import' and 'export' may only appear at the top level"), this.inModule) || this.raise(this.start, "'import' and 'export' may appear only with 'sourceType: module'"), s === g._import ? this.parseImport(a) : this.parseExport(a, r);
                default:
    ...
    e.parseFunction = function $parseFunction(e, t, r, i, n) {
        ...
        var r = this.strict,
            ...
            n = this.startNode(),
            s = !1;
        for (n.body = [], this.expect(g.braceL); this.type !== g.braceR;) {
        ...
        if (this.eatContextual("static")) {
            if (13 <= t && this.eat(g.braceL)) return this.parseClassStaticBlock(r), r;
        ...
        if (this.shouldParseExportStatement()) e.declaration = this.parseExportDeclaration(e), "VariableDeclaration" === e.declaration.type ? this.checkVariableExport(t, e.declaration.declarations) : this.checkExport(t, e.declaration.id, e.declaration.id.start), e.specifiers = [], e.source = null;
            ...
            if (e.declaration = null, e.specifiers = this.parseExportSpecifiers(t), this.eatContextual("from")) this.type !== g.string && this.unexpected(), e.source = this.parseExprAtom(), 16 <= this.options.ecmaVersion && (e.attributes = this.parseWithClause());
            else {
        ...
        if (this.type !== g.name || (e.push(this.parseImportDefaultSpecifier()), this.eat(g.comma)))
            if (this.type === g.star) e.push(this.parseImportNamespaceSpecifier());
            else
                for (this.expect(g.braceL); !this.eat(g.braceR);) {
                    if (t) t = !1;
                    else if (this.expect(g.comma), this.afterTrailingComma(g.braceR)) break;
        ...
        if (this.eat(g._with)) {
            ...
            for (var t = {}, r = !0; !this.eat(g.braceR);) {
                if (r) r = !1;
                else if (this.expect(g.comma), this.afterTrailingComma(g.braceR)) break;
                var i = this.parseImportAttribute(),
                    n = "Identifier" === i.key.type ? i.key.name : i.key.value;
                ke(t, n) && this.raiseRecoverable(i.key.start, "Duplicate attribute key '" + n + "'"), t[n] = !0, e.push(i)
            }
        }
        return e
    ...
    var e = l.prototype,
        d = (e.toAssignable = function $toAssignable(e, t, r) {
            ...
            if (6 <= this.options.ecmaVersion) switch (this.type) {
                case g.bracketL:
                    var e = this.startNode();
                    return this.next(), e.elements = this.parseBindingList(g.bracketR, !0, !0), this.finishNode(e, "ArrayPattern");
                case g.braceL:
            ...
            for (var n = [], s = !0; !this.eat(e);)
                if (s ? s = !1 : this.expect(g.comma), t && this.type === g.comma) n.push(null);
                    ...
                    if (this.type === g.ellipsis) {
                        ...
                        this.parseBindingListItem(a), n.push(a), this.type === g.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.expect(e);
                        break
                    }
    ...
    e.checkPropClash = function $checkPropClash(e, t, r) {
        ...
        var i = !1,
            ...
            s = -1,
            a = -1,
            o = (t ? (n = t.parenthesizedAssign, s = t.trailingComma, a = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new Re, i = !0), this.start),
            c = this.startLoc,
        ...
        if (this.isContextual("await") && this.canAwait) n = this.parseAwait(i), t = !0;
            ...
            o.operator = this.value, o.prefix = !0, this.next(), o.argument = this.parseMaybeUnary(null, !0, c, i), this.checkExpressionErrors(e, !0), c ? this.checkLValSimple(o.argument) : this.strict && "delete" === o.operator && function e(t) {
                return "Identifier" === t.type || "ParenthesizedExpression" === t.type && e(t.expression)
            }(o.argument) ? this.raiseRecoverable(o.start, "Deleting local variable in strict mode") : "delete" === o.operator && function e(t) {
                return "MemberExpression" === t.type && "PrivateIdentifier" === t.property.type || "ChainExpression" === t.type && e(t.expression) || "ParenthesizedExpression" === t.type && e(t.expression)
        ...
        if (h || c && this.type !== g.parenL && this.type !== g.backQuote || this.eat(g.dot)) {
            var l = this.startNodeAt(t, r);
            l.object = e, h ? (l.property = this.parseExpression(), this.expect(g.bracketR)) : this.type === g.privateId && "Super" !== e.type ? l.property = this.parsePrivateIdent() : l.property = this.parseIdent("never" !== this.options.allowReserved), l.computed = !!h, o && (l.optional = c), e = this.finishNode(l, "MemberExpression")
        } else if (!i && this.eat(g.parenL)) {
            var h = new Re,
                l = this.yieldPos,
                i = this.awaitPos,
                u = this.awaitIdentPos,
                p = (this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.parseExprList(g.parenR, 8 <= this.options.ecmaVersion, !1, h));
            if (n && !c && this.shouldParseAsyncArrow()) return this.checkPatternErrors(h, !1), this.checkYieldAwaitInDefaultParams(), 0 < this.awaitIdentPos && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = l, this.awaitPos = i, this.awaitIdentPos = u, this.parseSubscriptAsyncArrow(t, r, p, a);
            this.checkExpressionErrors(h, !0), this.yieldPos = l || this.yieldPos, this.awaitPos = i || this.awaitPos, this.awaitIdentPos = u || this.awaitIdentPos;
            n = this.startNodeAt(t, r);
            n.callee = e, n.arguments = p, o && (n.optional = c), e = this.finishNode(n, "CallExpression")
        } else this.type === g.backQuote && ((c || s) && this.raise(this.start, "Optional chaining cannot appear in the tag of tagged template expressions"), (a = this.startNodeAt(t, r)).tag = e, a.quasi = this.parseTemplate({
            isTagged: !0
        ...
        switch (this.type) {
            ...
            case g.name:
                var n = this.start,
                    ...
                    a = this.containsEsc,
                    o = this.parseIdent(!1);
                if (8 <= this.options.ecmaVersion && !a && "async" === o.name && !this.canInsertSemicolon() && this.eat(g._function)) return this.overrideContext(d.f_expr), this.parseFunction(this.startNodeAt(n, s), 0, !1, !0, t);
                if (i && !this.canInsertSemicolon()) {
                    if (this.eat(g.arrow)) return this.parseArrowExpression(this.startNodeAt(n, s), [o], !1, t);
                    if (8 <= this.options.ecmaVersion && "async" === o.name && this.type === g.name && !a && (!this.potentialArrowInForAwait || "of" !== this.value || this.containsEsc)) return o = this.parseIdent(!1), !this.canInsertSemicolon() && this.eat(g.arrow) || this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, s), [o], !0, t)
                }
                return o;
            case g.regexp:
                var c, a = this.value;
            ...
            case g._true:
            case g._false:
                return (c = this.startNode()).value = this.type === g._null ? null : this.type === g._true, c.raw = this.type.keyword, this.next(), this.finishNode(c, "Literal");
            case g.parenL:
            ...
            case g.bracketL:
                return c = this.startNode(), this.next(), c.elements = this.parseExprList(g.bracketR, !0, !0, e), this.finishNode(c, "ArrayExpression");
            case g.braceL:
        ...
        if (6 <= this.options.ecmaVersion) {
            ...
            for (this.yieldPos = 0, this.awaitPos = 0; this.type !== g.parenR;) {
                if (l ? l = !1 : this.expect(g.comma), s && this.afterTrailingComma(g.parenR, !0)) {
                    u = !0;
                    break
                }
                if (this.type === g.ellipsis) {
                    a = this.start, h.push(this.parseParenItem(this.parseRestBinding())), this.type === g.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element");
                    break
                }
            ...
            if (this.expect(g.parenR), e && this.shouldParseArrow(h) && this.eat(g.arrow)) return this.checkPatternErrors(p, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = d, this.awaitPos = f, this.parseParenArrowList(i, n, h, t);
    ...
    var He = [],
        e = (e.parseNew = function $parseNew() {
            ...
            for (r.quasis = [i]; !i.tail;) this.type === g.eof && this.raise(this.pos, "Unterminated template literal"), this.expect(g.dollarBraceL), r.expressions.push(this.parseExpression()), this.expect(g.braceR), r.quasis.push(i = this.parseTemplateElement({
                isTagged: t
            }));
            ...
            for (r.properties = [], this.next(); !this.eat(g.braceR);) {
                if (i) i = !1;
                else if (this.expect(g.comma), 5 <= this.options.ecmaVersion && this.afterTrailingComma(g.braceR)) break;
    ...
    var e = "ASCII ASCII_Hex_Digit AHex Alphabetic Alpha Any Assigned Bidi_Control Bidi_C Bidi_Mirrored Bidi_M Case_Ignorable CI Cased Changes_When_Casefolded CWCF Changes_When_Casemapped CWCM Changes_When_Lowercased CWL Changes_When_NFKC_Casefolded CWKCF Changes_When_Titlecased CWT Changes_When_Uppercased CWU Dash Default_Ignorable_Code_Point DI Deprecated Dep Diacritic Dia Emoji Emoji_Component Emoji_Modifier Emoji_Modifier_Base Emoji_Presentation Extender Ext Grapheme_Base Gr_Base Grapheme_Extend Gr_Ext Hex_Digit Hex IDS_Binary_Operator IDSB IDS_Trinary_Operator IDST ID_Continue IDC ID_Start IDS Ideographic Ideo Join_Control Join_C Logical_Order_Exception LOE Lowercase Lower Math Noncharacter_Code_Point NChar Pattern_Syntax Pat_Syn Pattern_White_Space Pat_WS Quotation_Mark QMark Radical Regional_Indicator RI Sentence_Terminal STerm Soft_Dotted SD Terminal_Punctuation Term Unified_Ideograph UIdeo Uppercase Upper Variation_Selector VS White_Space space XID_Continue XIDC XID_Start XIDS",
        y = e + " Extended_Pictographic",
        Ke = y + " EBase EComp EMod EPres ExtPict",
        Qe = {
            9: e,
            10: y,
            11: y,
        ...
        y = e + " Dogra Dogr Gunjala_Gondi Gong Hanifi_Rohingya Rohg Makasar Maka Medefaidrin Medf Old_Sogdian Sogo Sogdian Sogd",
        Ke = y + " Elymaic Elym Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Wancho Wcho",
        Ze = Ke + " Chorasmian Chrs Diak Dives_Akuru Khitan_Small_Script Kits Yezi Yezidi",
        Je = Ze + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
        $e = {
            9: e,
            10: y,
            11: Ke,
        ...
        et = {};
    for (var x, tt = 0, rt = [9, 10, 11, 12, 13, 14]; tt < rt.length; tt += 1)(x = et[x = rt[tt]] = {
        binary: Ce(Qe[x] + " " + Ye),
        binaryOfStrings: Ce(Xe[x]),
        nonBinary: {
            General_Category: Ce(Ye),
            Script: Ce($e[x])
        }
    }).nonBinary.Script_Extensions = x.nonBinary.Script, x.nonBinary.gc = x.nonBinary.General_Category, x.nonBinary.sc = x.nonBinary.Script, x.nonBinary.scx = x.nonBinary.Script_Extensions;
    ...
    w.prototype.reset = function $reset(e, t, r) {
                ...
                if (16 <= this.options.ecmaVersion) {
                    ...
                    if (r || i) {
                        for (var n = 0; n < r.length; n++) {
                            var s = r.charAt(n); - 1 < r.indexOf(s, n + 1) && e.raise("Duplicate regular expression modifiers")
                        }
                        if (i) {
                            var a = this.regexp_eatModifiers(e);
                            r || a || 58 !== e.current() || e.raise("Invalid regular expression modifiers");
                            for (var o = 0; o < a.length; o++) {
                                var c = a.charAt(o);
                                (-1 < a.indexOf(c, o + 1) || -1 < r.indexOf(c)) && e.raise("Duplicate regular expression modifiers")
                            }
                        }
                    }
                }
        ...
        if (e.eat(63)) {
            ...
            if (r)
                if (t)
                    for (var i = 0, n = r; i < n.length; i += 1) n[i].separatedFrom(e.branchID) || e.raise("Duplicate capture group name");
    ...
    e.regexp_eatCharacterClassEscape = function $regexp_eatCharacterClassEscape(e) {
        ...
        if (e.eat(92)) {
            ...
            e.switchU && (99 !== (r = e.current()) && !lt(r) || e.raise("Invalid class escape"), e.raise("Invalid escape")), e.pos = t
        }
        var r = e.current();
        ...
        for (var r = e.pos, i = e.lastIntValue = 0; i < t; ++i) {
            ...
            e.lastIntValue = 16 * e.lastIntValue + ht(n), e.advance()
        }
        return !0
    };

    function ut(e) {
        this.type = e.type, this.value = e.value, this.start = e.start, this.end = e.end, e.options.locations && (this.loc = new Ae(e, e.startLoc, e.endLoc)), e.options.ranges && (this.range = [e.start, e.end])
    }
    y = l.prototype;
    ...
    y.next = function $next(e) {
        ...
        e: for (; this.pos < this.input.length;) {
            ...
            switch (e) {
                ...
                case 47:
                    ...
                    break;
                default:
                    if (!(8 < e && e < 14 || 5760 <= e && xe.test(String.fromCharCode(e)))) break e;
                    ++this.pos
            }
        }
        ...
        if (11 <= e) {
            ...
            if (46 === t) {
                ...
                if (r < 48 || 57 < r) return this.finishOp(g.questionDot, 2)
            }
            if (63 === t) {
                if (12 <= e)
                    if (61 === this.input.charCodeAt(this.pos + 2)) return this.finishOp(g.assign, 3);
        ...
        var n = this.input.slice(r, this.pos),
            s = (++this.pos, this.pos),
            a = this.readWord1(),
            s = (this.containsEsc && this.unexpected(s), this.regexpState || (this.regexpState = new w(this))),
        ...
        for (var i = 12 <= this.options.ecmaVersion && void 0 === t, n = r && 48 === this.input.charCodeAt(this.pos), r = this.pos, s = 0, a = 0, o = 0, c = null == t ? 1 / 0 : t; o < c; ++o, ++this.pos) {
            ...
            if (i && 95 === h) n && this.raiseRecoverable(this.pos, "Numeric separator is not allowed in legacy octal numeric literals"), 95 === a && this.raiseRecoverable(this.pos, "Numeric separator must be exactly one underscore"), 0 === o && this.raiseRecoverable(this.pos, "Numeric separator is not allowed at the first of digits"), a = h;
                ...
                if (e <= (l = 97 <= h ? h - 97 + 10 : 65 <= h ? h - 65 + 10 : 48 <= h && h <= 57 ? h - 48 : 1 / 0)) break;
                a = h, s = s * e + l
            }
        }
        ...
        if (!r && !e && 11 <= this.options.ecmaVersion && 110 === i) return e = pt(this.input.slice(t, this.pos)), ++this.pos, a(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(g.num, e);
        ...
        for (var t = "", r = ++this.pos;;) {
            ...
            if (i === e) break;
            92 === i ? (t = (t += this.input.slice(r, this.pos)) + this.readEscapedChar(!1), r = this.pos) : 8232 === i || 8233 === i ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (ve(i) && this.raise(this.start, "Unterminated string constant"), ++this.pos)
        }
    ...
    y.tryReadTemplateToken = function $tryReadTemplateToken() {
        ...
        for (var e = "", t = this.pos;;) {
            ...
            if (96 === r || 36 === r && 123 === this.input.charCodeAt(this.pos + 1)) return this.pos !== this.start || this.type !== g.template && this.type !== g.invalidTemplate ? (e += this.input.slice(t, this.pos), this.finishToken(g.template, e)) : 36 === r ? (this.pos += 2, this.finishToken(g.dollarBraceL)) : (++this.pos, this.finishToken(g.backQuote));
        ...
        for (var e = "", t = !(this.containsEsc = !1), r = this.pos, i = 6 <= this.options.ecmaVersion; this.pos < this.input.length;) {
            ...
            if (ye(n, i)) this.pos += n <= 65535 ? 1 : 2;
                ...
                (t ? a : ye)(s, i) || this.invalidStringToken(n, "Invalid Unicode escape"), e += h(s), r = this.pos
            }
            t = !1
        }
    ...
    Et.prototype.global = function $global() {
        ...
        var i = r.context[e];
        if (i) {
            if ("var" !== i.kind) throw new SyntaxError("Identifier '" + e + "' has already been declared");
            t !== C && i.set(t)
        } else r.context[e] = new wt("var", t === C ? void 0 : t);
        r.parent || (i = r.find("window").get(), t !== C && f(i, e, {
            value: t,
            writable: !0,
            enumerable: !0
        }))
    ...
    function Et(e, t) {
        void 0 === e && (e = null), void 0 === t && (t = !1), this.context = $(null), this.withContext = $(null), this.parent = e, this.isolated = t
    }
    ...
    function Ct(a, e) {
        ...
        return new Promise(function(t, r) {
            ...
            function s(e) {
                return e.done ? t(l ? e : e.value) : e.value !== ft ? t(e) : void((e = e.value.RES) && "function" === e.then ? e : Promise.resolve(e)).then(i, n)
            }
            "err" in e ? n(c) : i(o)
        })
    }
    ...
    function It(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            if (a = i.getVar, a = void 0 !== a && a, n = i.throwErr, n = void 0 === n || n, "undefined" !== t.name) {
                if (s = r.find(t.name)) {
                    if (a) return [2, s];
                    if ((a = s.get()) === I) throw new ReferenceError(t.name + " is not defined");
                    return [2, a]
                }
    ...
    function Tt(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = i.getObj, n = void 0 !== n && n, s = i.getVar, s = void 0 !== s && s, "Super" !== t.object.type ? [3, 2] : [5, b(Nt(t.object, r, {
                        getProto: !0
                    }))];
                case 1:
                    return a = e.sent(), [3, 4];
                case 2:
                    return [5, b(L(t.object, r))];
                case 3:
                    a = e.sent(), e.label = 4;
                case 4:
                    return n ? [2, a] : (c = !1, t.computed ? [5, b(L(t.property, r))] : [3, 6]);
                case 5:
                    return o = e.sent(), [3, 7];
                case 6:
                    "PrivateIdentifier" === t.property.type ? (o = t.property.name, c = !0) : o = t.property.name, e.label = 7;
                case 7:
                    return c && (a = a[E]), s ? (l = J(a, o), "Super" === t.object.type && l ? (u = r.find("this").get(), h = p(o), f(u, h, {
                        set: l
                    }), [2, new kt(u, h)]) : [2, new kt(a, o)]) : (l = Z(a, o), "Super" === t.object.type && l ? (u = r.find("this").get(), t.optional && null == u ? [2, void 0] : [2, l.call(u)]) : t.optional && null == a ? [2, void 0] : [2, a[o]])
            }
        })
    }
    ...
    function Nt(e, t, r) {
        var i, n;
        return void 0 === r && (r = {}), v(this, function(e) {
            return i = r.getProto, i = void 0 !== i && i, n = t.find(mt).get(), [2, i ? n.prototype : n]
        })
    }
    ...
    function Bt(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return [5, b(L(t.argument, r))];
                case 1:
                    if (n = e.sent(), i.spreadProps) return [2, n];
                    if ("function" == typeof Symbol && "function" != typeof n[Symbol.iterator]) throw new TypeError("Spread syntax requires ...iterable[Symbol.iterator] to be a function");
                    return [2, j(n)]
            }
        })
    }
    var Rt = Object.freeze({
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        i = [], n = 0, e.label = 1;
                    case 1:
                        return n < t.elements.length ? "SpreadElement" !== (s = t.elements[n]).type ? [3, 3] : (o = (a = i).concat, [5, b(Bt(s, r))]) : [3, 6];
                    case 2:
                        return i = o.apply(a, [e.sent()]), [3, 5];
                    case 3:
                        return h = (c = i).push, [5, b(L(s, r))];
                    case 4:
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        i = {}, n = 0, e.label = 1;
                    case 1:
                        return n < t.properties.length ? "SpreadElement" !== (s = t.properties[n]).type ? [3, 3] : (a = m, o = [i], [5, b(Bt(s, r, {
                            spreadProps: !0
                        }))]) : [3, 11];
                    case 2:
                    ...
                    case 6:
                        return l = "", [5, b(Pt(h))];
                    case 7:
                        c = l + e.sent(), e.label = 8;
                    case 8:
                        return [5, b(L(s.value, r))];
                    case 9:
                        u = e.sent(), "init" === (p = s.kind) ? i[c] = u : "get" === p ? (d = q(i, c), f(i, c, {
                            get: u,
                            set: d && d.set,
                            enumerable: !0,
                            configurable: !0
        ...
        UnaryExpression: function $UnaryExpression(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    ...
                    case 11:
                        return "Identifier" !== i.type ? [3, 13] : [5, b(It(i, r, {
                            throwErr: !1
                        }))];
                    case 12:
                    ...
                    case 14:
                        return [2, typeof e.sent()];
                    case 15:
                        return "MemberExpression" !== i.type ? [3, 17] : [5, b(Tt(i, r, {
                            getVar: !0
                        }))];
                    case 16:
                        return [2, e.sent().del()];
        ...
        UpdateExpression: function $UpdateExpression(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        return "Identifier" !== (i = t.argument).type ? [3, 2] : [5, b(It(i, r, {
                            getVar: !0
                        }))];
                    case 1:
                        return n = e.sent(), [3, 5];
                    case 2:
                        return "MemberExpression" !== i.type ? [3, 4] : [5, b(Tt(i, r, {
                            getVar: !0
                        }))];
                    case 3:
                        return n = e.sent(), [3, 5];
        ...
        BinaryExpression: function $BinaryExpression(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        return "PrivateIdentifier" !== t.left.type ? [3, 2] : (i = t.left.name, [5, b(L(t.right, r))]);
                    case 1:
                        return n = (n = e.sent())[E] || {}, [3, 5];
                    case 2:
                        return [5, b(L(t.left, r))];
                    case 3:
                        return i = e.sent(), [5, b(L(t.right, r))];
                    case 4:
                        n = e.sent(), e.label = 5;
                    case 5:
                        switch (t.operator) {
        ...
        AssignmentExpression: function $AssignmentExpression(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        return "Identifier" !== (i = t.left).type ? [3, 2] : [5, b(It(i, r, {
                            getVar: !0,
                            throwErr: !1
                        }))];
                    case 1:
                        return (n = e.sent()) || (s = r.global().find("window").get(), n = new kt(s, i.name)), [3, 7];
                    case 2:
                        return "MemberExpression" !== i.type ? [3, 4] : [5, b(Tt(i, r, {
                            getVar: !0
                        }))];
                    case 3:
                        return n = e.sent(), [3, 7];
                    case 4:
                        return [5, b(L(t.right, r))];
                    case 5:
                        return s = e.sent(), [5, b(B(i, r, {
                            feed: s
                        }))];
                    case 6:
                        return [2, e.sent()];
            ...
            return v(this, function(e) {
                switch (e.label) {
                    ...
                    case 1:
                        return [5, b(L(t.left, r))];
                    case 2:
                        return (i = e.sent()) ? [3, 4] : [5, b(L(t.right, r))];
                    case 3:
                        i = e.sent(), e.label = 4;
                    case 4:
                        return [2, i];
                    case 5:
                        return [5, b(L(t.left, r))];
                    case 6:
                        return (n = e.sent()) ? [5, b(L(t.right, r))] : [3, 8];
                    case 7:
                        n = e.sent(), e.label = 8;
                    case 8:
                        return [2, n];
        ...
        ConditionalExpression: function $ConditionalExpression(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        return [5, b(L(t.test, r))];
                    case 1:
                        return e.sent() ? [5, b(L(t.consequent, r))] : [3, 3];
                    case 2:
                        return i = e.sent(), [3, 5];
                    case 3:
                        return [5, b(L(t.alternate, r))];
                    case 4:
                        i = e.sent(), e.label = 5;
                    case 5:
                        return [2, i]
        ...
        CallExpression: function $CallExpression(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        return "MemberExpression" !== t.callee.type ? [3, 5] : [5, b(Tt(t.callee, r, {
                            getObj: !0
                        }))];
                    case 1:
                        return (i = e.sent(), t.callee.optional && null == i) ? [2, void 0] : (n = void 0, s = !1, t.callee.computed ? [5, b(L(t.callee.property, r))] : [3, 3]);
                    case 2:
                        return n = e.sent(), [3, 4];
                    case 3:
                        "PrivateIdentifier" === t.callee.property.type ? (n = t.callee.property.name, s = !0) : n = t.callee.property.name, e.label = 4;
                    case 4:
                        if (m = i, s && (m = m[E]), a = "Super" === t.callee.object.type ? (a = r.find("this").get(), m[n].bind(a)) : m[n], t.optional && null == a) return [2, void 0];
                        if ("function" != typeof a) throw new TypeError(n + " is not a function");
                        if (a[vt]) throw new TypeError("Class constructor " + n + " cannot be invoked without 'new'");
                        return [3, 7];
                    case 5:
                        return i = r.find("this").get(), [5, b(L(t.callee, r))];
                    case 6:
                        if (a = e.sent(), t.optional && null == a) return [2, void 0];
                        if ("function" != typeof a || "Super" !== t.callee.type && a[vt]) {
                            ...
                            throw "function" != typeof a ? new TypeError(o + " is not a function") : new TypeError("Class constructor " + o + " cannot be invoked without 'new'")
                        }
                        e.label = 7;
                    case 7:
                        c = [], h = 0, e.label = 8;
                    case 8:
                        return h < t.arguments.length ? "SpreadElement" !== (l = t.arguments[h]).type ? [3, 10] : (p = (u = c).concat, [5, b(Bt(l, r))]) : [3, 13];
                    case 9:
                        return c = p.apply(u, [e.sent()]), [3, 12];
                    case 10:
                        return f = (d = c).push, [5, b(L(l, r))];
                    case 11:
                        f.apply(d, [e.sent()]), e.label = 12;
                    case 12:
                        return h++, [3, 8];
                    case 13:
                        if ("Super" !== t.callee.type) return [3, 15];
                        if (m = r.find(yt), !0 === (g = m.get())) throw new ReferenceError("Super constructor may only be called once");
                        return y = te(i, a, c), [5, b(g(y))];
                    case 14:
                        return e.sent(), r.find("this").set(y), r.find(yt).set(!0), [2, y];
                    case 15:
                        try {
                            return [2, a.apply(i, c)]
                        } catch (e) {
                            if (e instanceof TypeError && "Illegal invocation" === e.message && -1 !== a.toString().indexOf("[native code]") && (g = r.global().find("window").get()) && g[oe]) return [2, a.apply(g[oe], c)];
                            throw e
                        }
                        return [2]
                }
            ...
            return v(this, function(e) {
                switch (e.label) {
                    ...
                    case 1:
                        ...
                        if (i[gt]) throw new TypeError((i.name || "(intermediate value)") + " is not a constructor");
                        s = [], a = 0, e.label = 2;
                    case 2:
                        return a < t.arguments.length ? "SpreadElement" !== (o = t.arguments[a]).type ? [3, 4] : (h = (c = s).concat, [5, b(Bt(o, r))]) : [3, 7];
                    case 3:
                        return s = h.apply(c, [e.sent()]), [3, 6];
                    case 4:
                        return u = (l = s).push, [5, b(L(o, r))];
                    case 5:
                        u.apply(l, [e.sent()]), e.label = 6;
                    case 6:
                        return a++, [3, 2];
                    case 7:
        ...
        TemplateLiteral: function $TemplateLiteral(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    ...
                    case 2:
                        return (s = o + e.sent(), a = n.shift()) ? (c = s, [5, b(L(a, r))]) : [3, 4];
                    case 3:
            ...
            return v(this, function(e) {
                switch (e.label) {
                    ...
                    case 1:
                        ...
                        o = 0, e.label = 2;
                    case 2:
                        return o < s.length ? (h = (c = a).push, [5, b(L(s[o], r))]) : [3, 5];
                    case 3:
                        h.apply(c, [e.sent()]), e.label = 4;
                    case 4:
                        return o++, [3, 2];
                    case 5:
                        return [2, i.apply(void 0, j([U(n)], a))]
                }
            })
        },
        TemplateElement: Vt,
        ClassExpression: function $ClassExpression(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        return t.id && t.id.name ? (i = new P(r), [5, b(bi(t, i))]) : [3, 2];
                    case 1:
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        return [5, b(L(t.argument, r))];
                    case 1:
                        return (i = e.sent(), t.delegate) ? [5, b(i)] : [3, 3];
                    case 2:
                        return n = e.sent(), [3, 5];
                    case 3:
                        return [4, i];
        ...
        AwaitExpression: function $AwaitExpression(t, r) {
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        return i = ft, [5, b(L(t.argument, r))];
                    case 1:
                        return i.RES = e.sent(), [4, ft];
                    case 2:
                        return [2, e.sent()]
                }
            })
    ...
    function Dt(t, r, i) {
        var n, s, a, o, c, h, l, u, p, d, f;
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    n = i.kind, n = void 0 === n ? "var" : n, s = i.hoist, s = void 0 !== s && s, a = i.onlyBlock, a = void 0 !== a && a, o = i.feed, o = void 0 === o ? {} : o, c = [], h = 0, e.label = 1;
                case 1:
                    return h < t.properties.length ? (l = t.properties[h], s ? a || "var" === n ? "Property" !== l.type ? [3, 5] : "Identifier" !== (p = l.value).type ? [3, 2] : (r[n](p.name, a ? I : "var" === n ? C : void 0), [3, 4]) : [3, 7] : [3, 8]) : [3, 18];
                case 2:
                    return [5, b(B(p, r, {
                        kind: n,
                        hoist: s,
                ...
                case 7:
                    return [3, 17];
                case 8:
                    return "Property" !== l.type ? [3, 15] : (u = void 0, l.computed ? [5, b(L(l.key, r))] : [3, 10]);
                case 9:
                    return u = e.sent(), [3, 11];
                case 10:
                    u = l.key.name, e.label = 11;
                case 11:
                    return (c.push(u), "Identifier" !== (p = l.value).type) ? [3, 12] : (r[n](p.name, o[u]), [3, 14]);
                case 12:
                    return [5, b(B(p, r, {
                        kind: n,
                        feed: o[u]
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                ...
                case 1:
                    ...
                    if (!(l = t.elements[h])) return [3, 13];
                    if (!s) return [3, 5];
                    if (a || "var" === n) {
                        if ("Identifier" !== l.type) return [3, 2];
                        r[n](l.name, a ? I : "var" === n ? C : void 0)
                    }
                    return [3, 4];
                case 2:
                    return [5, b(B(l, r, {
                ...
                case 4:
                    return [3, 13];
                case 5:
                    return "Identifier" !== l.type ? [3, 9] : n ? (r[n](l.name, o[h]), [3, 8]) : [3, 6];
                case 6:
                    return [5, b(It(l, r, {
                        getVar: !0
                    }))];
                case 7:
                    (u = e.sent()).set(o[h]), c.push(u.get()), e.label = 8;
                case 8:
                    return [3, 13];
                case 9:
                    return "RestElement" !== l.type ? [3, 11] : [5, b(Mt(l, r, {
                        kind: n,
                        feed: o.slice(h)
                    }))];
                case 10:
    ...
    function Ft(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = i.kind, n = void 0 === n ? "var" : n, s = i.hoist, s = void 0 !== s && s, a = i.onlyBlock, a = void 0 !== a && a, void 0 !== (o = i.feed) ? [3, 2] : [5, b(L(t.right, r))];
                case 1:
                    return h = e.sent(), [3, 3];
                case 2:
                    h = o, e.label = 3;
                case 3:
                    if (c = h, l = t.left, !s) return [3, 7];
                    if (a || "var" === n) {
                        if ("Identifier" !== l.type) return [3, 4];
                        r[n](l.name, a ? I : "var" === n ? C : void 0)
                    }
                    return [3, 6];
                case 4:
                ...
                case 6:
                    return [3, 10];
                case 7:
                    return "Identifier" !== l.type ? [3, 8] : (r[n](l.name, c), [3, 10]);
                case 8:
                    return [5, b(B(l, r, {
                        kind: n,
                        feed: c
            ...
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        i = 0, e.label = 1;
                    case 1:
                        return i < t.body.length ? [5, b(L(t.body[i], r))] : [3, 4];
                    case 2:
                        e.sent(), e.label = 3;
                    case 3:
                        return i++, [3, 1];
    ...
    function Gt(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = i.invasived, n = void 0 !== n && n, a = i.hoisted, a = void 0 !== a && a, n = n ? r : new P(r), a ? [3, 2] : [5, b(vi(t, n, {
                        onlyBlock: !0
                    }))];
                case 1:
                    e.sent(), e.label = 2;
                case 2:
                    s = 0, e.label = 3;
                case 3:
                    return s < t.body.length ? [5, b(L(t.body[s], n))] : [3, 6];
                case 4:
                    if ((a = e.sent()) === _) return a.LABEL && a.LABEL === i.label ? [3, 6] : [2, a];
                    if (a === k || a === S) return [2, a];
                    e.label = 5;
                case 5:
                    return s++, [3, 3];
                case 6:
    ...
    function Kt(t, r) {
        ...
        return v(this, function(e) {
            switch (e.label) {
                case 0:
                    return (i = S, t.argument) ? [5, b(L(t.argument, r))] : [3, 2];
                case 1:
                    return n = e.sent(), [3, 3];
                case 2:
                    n = void 0, e.label = 3;
    ...
    function Qt(t) {
        var r;
        return v(this, function(e) {
            return _.LABEL = null == (r = t.label) ? void 0 : r.name, [2, _]
        })
    }
    ...
    function Xt(t) {
        var r;
        return v(this, function(e) {
            return k.LABEL = null == (r = t.label) ? void 0 : r.name, [2, k]
        })
    }
    ...
    function Yt(t, r) {
        ...
        return v(this, function(e) {
            switch (e.label) {
                case 0:
                    return i = t.label.name, "WhileStatement" !== t.body.type ? [3, 2] : [5, b(nr(t.body, r, {
                        label: i
                    }))];
                case 1:
                    return [2, e.sent()];
                case 2:
                    return "DoWhileStatement" !== t.body.type ? [3, 4] : [5, b(sr(t.body, r, {
                        label: i
                    }))];
                case 3:
                    return [2, e.sent()];
                case 4:
                    return "ForStatement" !== t.body.type ? [3, 6] : [5, b(ar(t.body, r, {
                        label: i
                    }))];
                case 5:
                    return [2, e.sent()];
                case 6:
                    return "ForInStatement" !== t.body.type ? [3, 8] : [5, b(or(t.body, r, {
                        label: i
                    }))];
                case 7:
                    return [2, e.sent()];
                case 8:
                    return "ForOfStatement" !== t.body.type ? [3, 10] : [5, b(cr(t.body, r, {
                        label: i
                    }))];
                case 9:
                    return [2, e.sent()];
                case 10:
                    return "BlockStatement" !== t.body.type ? [3, 12] : [5, b(Gt(t.body, r, {
                        label: i
                    }))];
                case 11:
                    return [2, e.sent()];
                case 12:
                    return "WithStatement" !== t.body.type ? [3, 14] : [5, b(Zt(t.body, r, {
                        label: i
                    }))];
                case 13:
                    return [2, e.sent()];
                case 14:
                    return "IfStatement" !== t.body.type ? [3, 16] : [5, b(Jt(t.body, r, {
                        label: i
                    }))];
                case 15:
                    return [2, e.sent()];
                case 16:
                    return "SwitchStatement" !== t.body.type ? [3, 18] : [5, b($t(t.body, r, {
                        label: i
                    }))];
                case 17:
                    return [2, e.sent()];
                case 18:
                    return "TryStatement" !== t.body.type ? [3, 20] : [5, b(rr(t.body, r, {
                        label: i
                    }))];
                case 19:
                    return [2, e.sent()];
                case 20:
                    throw new SyntaxError(t.body.type + " cannot be labeled")
            }
        })
    }
    ...
    function Zt(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = new P(r), a = (s = n).with, [5, b(L(t.object, r))];
                case 1:
                    return a.apply(s, [e.sent()]), [5, b(L(t.body, n))];
                case 2:
                    return (o = e.sent()) === _ ? o.LABEL && o.LABEL === i.label ? [2] : [2, o] : o === k || o === S ? [2, o] : [2]
            }
        })
    }
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                ...
                case 4:
                    n = e.sent(), e.label = 5;
                case 5:
                    return n === _ ? n.LABEL && n.LABEL === i.label ? [2] : [2, n] : n === k || n === S ? [2, n] : [2]
            }
        })
    }
    ...
    function $t(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return [5, b(L(t.discriminant, r))];
                case 1:
                    n = e.sent(), s = !1, a = 0, e.label = 2;
                case 2:
                    return a < t.cases.length ? (o = t.cases[a], (c = !s) ? (h = !o.test) ? [3, 4] : [5, b(L(o.test, r))] : [3, 5]) : [3, 8];
                case 3:
                    h = e.sent() === n, e.label = 4;
                case 4:
                    c = h, e.label = 5;
                case 5:
                    return (s = !!c || s) ? [5, b(er(o, r))] : [3, 7];
                case 6:
                    if ((l = e.sent()) === _) return l.LABEL === i.label ? [3, 8] : [2, l];
                    if (l === k || l === S) return [2, l];
                    e.label = 7;
                case 7:
                    return a++, [3, 2];
                case 8:
    ...
    function rr(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return e.trys.push([0, 2, 9, 12]), [5, b(Gt(t.block, r))];
                case 1:
                    return n = e.sent(), [3, 12];
                case 2:
                    if (s = e.sent(), !t.handler) return [3, 7];
                    if (a = new P(r), o = t.handler.param) {
                        if ("Identifier" !== o.type) return [3, 3];
                        c = o.name, a.var(c, s)
                    }
                    return [3, 5];
                case 3:
                ...
                case 8:
                    return [3, 12];
                case 9:
                    return t.finalizer ? [5, b(Gt(t.finalizer, r))] : [3, 11];
                case 10:
                    n = e.sent(), e.label = 11;
                case 11:
                    return [7];
    ...
    function nr(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                ...
                case 2:
                    return (n = e.sent()) === _ ? n.LABEL === i.label ? [3, 3] : [2, n] : n === k ? n.LABEL === i.label ? [3, 0] : [2, n] : n === S ? [2, n] : [3, 0];
                case 3:
                    return [2]
            }
        })
    ...
    function sr(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return [5, b(L(t.body, r))];
                case 1:
                    if ((n = e.sent()) === _) return n.LABEL === i.label ? [3, 4] : [2, n];
                    if (n === k) return n.LABEL === i.label ? [3, 2] : [2, n];
                    if (n === S) return [2, n];
                    e.label = 2;
                case 2:
                    return [5, b(L(t.test, r))];
    ...
    function ar(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = new P(r), [5, b(L(t.init, n))];
                case 1:
                    e.sent(), e.label = 2;
                case 2:
                    return t.test ? [5, b(L(t.test, n))] : [3, 4];
                case 3:
                    return s = e.sent(), [3, 5];
                case 4:
                    s = !0, e.label = 5;
                case 5:
                    return s ? (a = new P(n), o = void 0, "BlockStatement" !== t.body.type ? [3, 7] : [5, b(Gt(t.body, a, {
                        invasived: !0
                    }))]) : [3, 12];
                case 6:
                    return o = e.sent(), [3, 9];
                case 7:
                    return [5, b(L(t.body, a))];
                case 8:
                    o = e.sent(), e.label = 9;
                case 9:
                    if (o === _) return o.LABEL === i.label ? [3, 12] : [2, o];
                    if (o === k) return o.LABEL === i.label ? [3, 10] : [2, o];
                    if (o === S) return [2, o];
                    e.label = 10;
                case 10:
                    return [5, b(L(t.update, n))];
                case 11:
                    return e.sent(), [3, 2];
                case 12:
                    return [2]
    ...
    function or(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = [], [5, b(L(t.right, r))];
                case 1:
                    for (s in e.sent()) n.push(s);
                    a = 0, e.label = 2;
                case 2:
                    return a < n.length ? (o = n[a], [5, b(xi(t, r, {
                        value: o
                    }))]) : [3, 5];
                case 3:
                    if ((o = e.sent()) === _) return o.LABEL === i.label ? [3, 5] : [2, o];
                    if (o === k) return o.LABEL === i.label ? [3, 4] : [2, o];
                    if (o === S) return [2, o];
                    e.label = 4;
                case 4:
                    return a++, [3, 2];
    ...
    function cr(n, s, a) {
        var o, c, h, l, u, p, d, f, m;
        return void 0 === a && (a = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                ...
                case 1:
                    ...
                    }), h = void 0, ft.RES = c.next(), [4, ft]) : [3, 8];
                case 2:
                    h = e.sent(), e.label = 3;
                case 3:
                    return h.done ? [3, 7] : [5, b(xi(n, s, {
                        value: h.value
                    }))];
                case 4:
                    if ((p = e.sent()) === _) return p.LABEL === a.label ? [3, 7] : [2, p];
                    if (p === k) return p.LABEL === a.label ? [3, 5] : [2, p];
                    if (p === S) return [2, p];
                    e.label = 5;
                case 5:
                    return ft.RES = c.next(), [4, ft];
                case 6:
                    return h = e.sent(), [3, 3];
                case 7:
                    return [3, 15];
                case 8:
                    e.trys.push([8, 13, 14, 15]), l = b(o), u = l.next(), e.label = 9;
                case 9:
                    return u.done ? [3, 12] : (d = u.value, [5, b(xi(n, s, {
                        value: d
                    }))]);
                case 10:
                    if ((p = e.sent()) === _) return p.LABEL === a.label ? [3, 12] : [2, p];
                    if (p === k) return p.LABEL === a.label ? [3, 11] : [2, p];
                    if (p === S) return [2, p];
                    e.label = 11;
                case 11:
                    return u = l.next(), [3, 9];
    ...
    function hr(t, r) {
        return v(this, function(e) {
            return r.func(t.id.name, R(t, r)), [2]
        })
    }
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    n = 0, e.label = 1;
                case 1:
                    return n < t.declarations.length ? [5, b(ur(t.declarations[n], r, m({
                        kind: t.kind
                    }, i)))] : [3, 4];
                case 2:
                    e.sent(), e.label = 3;
            ...
            switch (e.label) {
                case 0:
                    ...
                    if (a || "var" === n) {
                        ...
                        r[n](t.id.name, a ? I : "var" === n ? C : void 0)
                    }
                    return [3, 3];
                case 1:
                    return [5, b(B(t.id, r, {
                ...
                case 3:
                    return [3, 10];
                case 4:
                    return (c = "feed" in i) ? (l = o, [3, 7]) : [3, 5];
                case 5:
                    return [5, b(L(t.init, r))];
                case 6:
                    l = e.sent(), e.label = 7;
                case 7:
                    return (h = l, "Identifier" !== t.id.type) ? [3, 8] : (u = t.id.name, "var" !== n || t.init || c ? r[n](u, h) : r.var(u, C), t.init && -1 !== ["ClassExpression", "FunctionExpression", "ArrowFunctionExpression"].indexOf(t.init.type) && !h.name && f(h, "name", {
                        value: u,
                        configurable: !0
                    }), [3, 10]);
                case 8:
    ...
    function pr(t, r) {
        ...
        return v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = (i = r).func, s = [t.id.name], [5, b(bi(t, r))];
                case 1:
    ...
    function dr(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                ...
                case 1:
                    return a < t.body.length ? "MethodDefinition" !== (o = t.body[a]).type ? [3, 3] : [5, b(fr(o, r, {
                        klass: n,
                        superClass: s
                    }))] : [3, 8];
                case 2:
                    return e.sent(), [3, 7];
                case 3:
                    return "PropertyDefinition" === o.type && o.static ? [5, b(mr(o, r, {
                        klass: n,
                        superClass: s
                    }))] : [3, 5];
                case 4:
                    return e.sent(), [3, 7];
                case 5:
                    return "StaticBlock" !== o.type ? [3, 7] : [5, b(yr(o, r, {
                        klass: n,
                        superClass: s
                    }))];
                case 6:
            ...
            switch (e.label) {
                ...
                case 2:
                    if ("Identifier" === t.key.type) a = t.key.name;
                        ...
                        if ("PrivateIdentifier" !== t.key.type) throw new SyntaxError("Unexpected token");
                        a = t.key.name, o = !0
                    }
                    e.label = 3;
                case 3:
                    switch (c = t.static ? n : n.prototype, o && (c[E] || f(c, E, {
                            value: {}
                        }), c = c[E]), h = R(t.value, r, {
                            superClass: s
                        }), t.kind) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                ...
                case 2:
                    ...
                    e.label = 3;
                case 3:
                    return ((c = new P(r, !0)).const("this", n), h = n, o && (h[E] || f(h, E, {
                        value: {}
                    }), h = h[E]), t.value) ? [3, 4] : (h[a] = void 0, [3, 7]);
                case 4:
                    return "FunctionExpression" !== t.value.type && "ArrowFunctionExpression" !== t.value.type ? [3, 5] : (h[a] = R(t.value, c, {
                        superClass: s
                    }), [3, 7]);
                case 5:
                    return l = h, u = a, [5, b(L(t.value, c))];
                case 6:
                    l[u] = e.sent(), e.label = 7;
                case 7:
                    return [2]
            }
        })
    ...
    function yr(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = i.klass, (s = new P(r, !0)).const("this", n), [5, b(Gt(t, s, {
                        invasived: !0
                    }))];
                case 1:
                    return [2, e.sent()]
    ...
    function gr(t, r) {
        var i, n, s, a, o;
        return v(this, function(e) {
            if (n = r.global(), (n = n.find(xt + t.source.value)) && (n = n.get()) && ("function" == typeof n ? i = n() : "object" == typeof n && (i = n)), !i || "object" != typeof i) throw new TypeError('Failed to resolve module specifier "' + t.source.value + '"');
            for (s = 0; s < t.specifiers.length; s++) {
                if (a = t.specifiers[s], o = void 0, "ImportSpecifier" === a.type ? o = "Identifier" === a.imported.type ? a.imported.name : a.imported.value : "ImportDefaultSpecifier" === a.type ? o = "default" : "ImportNamespaceSpecifier" === a.type && (o = "*"), "*" !== o && !G(i, o)) throw new SyntaxError('The requested module "' + t.source.value + '" does not provide an export named "' + o + '"');
    ...
    function vr(t, r) {
        ...
        return v(this, function(e) {
            switch (e.label) {
                case 0:
                    return (i = r.global(), "FunctionDeclaration" !== t.declaration.type) ? [3, 1] : (n = R(t.declaration, r), r.func(t.declaration.id.name, n), [3, 5]);
                case 1:
                    return "ClassDeclaration" !== t.declaration.type ? [3, 3] : [5, b(bi(t.declaration, r))];
                case 2:
                    return n = e.sent(), r.func(t.declaration.id.name, n), [3, 5];
                case 3:
                    return [5, b(L(t.declaration, r))];
                case 4:
                    n = e.sent(), e.label = 5;
                case 5:
                    return (s = i.find(A)) && (s = s.get()) && "object" == typeof s && (s.default = n), [2]
            }
        })
    }
    ...
    function br(t, r) {
        ...
        return v(this, function(e) {
            switch (e.label) {
                case 0:
                    return (i = r.global(), t.declaration) ? "FunctionDeclaration" !== t.declaration.type ? [3, 1] : (n = R(t.declaration, r), r.func(t.declaration.id.name, n), (c = i.find(A)) && (s = c.get()) && "object" == typeof s && (s[t.declaration.id.name] = n), [3, 5]) : [3, 6];
                case 1:
                    return "ClassDeclaration" !== t.declaration.type ? [3, 3] : [5, b(bi(t.declaration, r))];
                case 2:
                    return n = e.sent(), r.func(t.declaration.id.name, n), (c = i.find(A)) && (s = c.get()) && "object" == typeof s && (s[t.declaration.id.name] = n), [3, 5];
                case 3:
                    return "VariableDeclaration" !== t.declaration.type ? [3, 5] : [5, b(lr(t.declaration, r))];
                case 4:
                    if (e.sent(), (c = i.find(A)) && (a = c.get()) && "object" == typeof a)
                        for (l = 0; l < t.declaration.declarations.length; l++) o = t.declaration.declarations[l].id.name, (d = r.find(o)) && (a[o] = d.get());
                    e.label = 5;
                case 5:
                    return [3, 7];
                case 6:
                    if (t.specifiers && (c = i.find(A)) && (h = c.get()) && "object" == typeof h)
                        for (l = 0; l < t.specifiers.length; l++) u = t.specifiers[l], p = "Identifier" === u.local.type ? u.local.name : u.local.value, (d = r.find(p)) && (h["Identifier" === u.exported.type ? u.exported.name : u.exported.value] = d.get());
                    e.label = 7;
                case 7:
                    return [2]
            }
    ...
    function xr(t, r) {
        var i, n, s;
        return v(this, function(e) {
            if (s = r.global(), (n = s.find(xt + t.source.value)) && (n = n.get()) && ("function" == typeof n ? i = n() : "object" == typeof n && (i = n)), i && "object" == typeof i) return (n = s.find(A)) && (s = n.get()) && "object" == typeof s && m(s, i), [2];
            throw new TypeError('Failed to resolve module specifier "' + t.source.value + '"')
        })
    }
    ...
    function wr(e, t, r) {
        ...
        if ("undefined" !== e.name) {
            ...
            if (t) {
                if (i) return t;
                i = t.get();
                if (i === I) throw new ReferenceError(e.name + " is not defined");
                return i
            }
    ...
    function Er(e, t, r) {
        var i, n = (r = void 0 === r ? {} : r).getObj,
            ...
            r = r.getVar,
            r = void 0 !== r && r,
            s = "Super" === e.object.type ? Ir(e.object, t, {
                getProto: !0
            }) : T(e.object, t);
        if (n) return s;
        n = !1;
        if (e.computed ? i = T(e.property, t) : "PrivateIdentifier" === e.property.type ? (i = e.property.name, n = !0) : i = e.property.name, n && (s = s[E]), r) return n = J(s, i), "Super" === e.object.type && n ? (a = t.find("this").get(), r = p(i), f(a, r, {
            set: n
        }), new kt(a, r)) : new kt(s, i);
        n = Z(s, i);
    ...
    function Ir(e, t, r) {
        r = (r = void 0 === r ? {} : r).getProto, r = void 0 !== r && r, t = t.find(mt).get();
    ...
    function Ar(e, t, r) {
        void 0 === r && (r = {});
        e = T(e.argument, t);
        if (r.spreadProps) return e;
        if ("function" == typeof Symbol && "function" != typeof e[Symbol.iterator]) throw new TypeError("Spread syntax requires ...iterable[Symbol.iterator] to be a function");
        return j(e)
    }
    var Pr = Object.freeze({
        ...
        ObjectExpression: function $ObjectExpression(e, t) {
            for (var r = {}, i = 0; i < e.properties.length; i++) {
                ...
                "SpreadElement" === o.type ? m(r, Ar(o, t, {
                    spreadProps: !0
                })) : (n = void 0, s = o.key, n = o.computed ? T(s, t) : "Identifier" === s.type ? s.name : "" + kr(s), s = T(o.value, t), "init" === (o = o.kind) ? r[n] = s : "get" === o ? (a = q(r, n), f(r, n, {
                    get: s,
                    set: a && a.set,
                    enumerable: !0,
                    configurable: !0
        ...
        UnaryExpression: function $UnaryExpression(e, t) {
            ...
            switch (e.operator) {
                ...
                case "void":
                    return void T(r, t);
                case "typeof":
                    return "Identifier" === r.type ? typeof wr(r, t, {
                        throwErr: !1
                    }) : typeof T(r, t);
                case "delete":
                    if ("MemberExpression" === r.type) return Er(r, t, {
                        getVar: !0
                    }).del();
        ...
        AssignmentExpression: function $AssignmentExpression(e, t) {
            ...
            if ("Identifier" === s.type)(n = wr(s, t, {
                getVar: !0,
                throwErr: !1
            })) || (i = t.global().find("window").get(), n = new kt(i, s.name));
            else {
                if ("MemberExpression" !== s.type) return V(s, t, {
                    feed: T(e.right, t)
                });
                n = Er(s, t, {
                    getVar: !0
        ...
        CallExpression: function $CallExpression(e, t) {
            ...
            if ("MemberExpression" === e.callee.type) {
                ...
                var i = void 0,
                    n = !1,
                    s = (e.callee.computed ? i = T(e.callee.property, t) : "PrivateIdentifier" === e.callee.property.type ? (i = e.callee.property.name, n = !0) : i = e.callee.property.name, r);
                if (n && (s = s[E]), n = "Super" === e.callee.object.type ? (n = t.find("this").get(), s[i].bind(n)) : s[i], e.optional && null == n) return;
                if ("function" != typeof n) throw new TypeError(i + " is not a function");
                if (n[vt]) throw new TypeError("Class constructor " + i + " cannot be invoked without 'new'")
            } else {
                if (r = t.find("this").get(), n = T(e.callee, t), e.optional && null == n) return;
                if ("function" != typeof n || "Super" !== e.callee.type && n[vt]) {
                    if ("Identifier" === e.callee.type) h = e.callee.name;
                    else try {
                        h = JSON.stringify(n)
                    } catch (e) {
                        h = "" + n
                    }
                    throw "function" != typeof n ? new TypeError(h + " is not a function") : new TypeError("Class constructor " + h + " cannot be invoked without 'new'")
                }
            }
            for (var a = [], o = 0; o < e.arguments.length; o++) {
                var c = e.arguments[o];
                "SpreadElement" === c.type ? a = a.concat(Ar(c, t)) : a.push(T(c, t))
            }
            if ("Super" === e.callee.type) {
                s = t.find(yt).get();
                if (!0 === s) throw new ReferenceError("Super constructor may only be called once");
                i = te(r, n, a);
                return s(i), t.find("this").set(i), t.find(yt).set(!0), i
            }
            try {
                return n.apply(r, a)
            } catch (e) {
                if (e instanceof TypeError && "Illegal invocation" === e.message && -1 !== n.toString().indexOf("[native code]")) {
                    var h = t.global().find("window").get();
                    if (h && h[oe]) return n.apply(h[oe], a)
                }
                throw e
            }
        },
    ...
    function Lr(e, t, r) {
        for (var i = (r = void 0 === r ? {} : r).kind, n = void 0 === i ? "var" : i, i = r.hoist, s = void 0 !== i && i, i = r.onlyBlock, a = void 0 !== i && i, i = r.feed, o = void 0 === i ? {} : i, c = [], h = 0; h < e.properties.length; h++) {
            ...
            if (s) !a && "var" !== n || ("Property" === l.type ? "Identifier" === (u = l.value).type ? t[n](u.name, a ? I : "var" === n ? C : void 0) : V(u, t, {
                kind: n,
                hoist: s,
                onlyBlock: a
            }) : Vr(l, t, {
            ...
            else if ("Property" === l.type) {
                var u, p = void 0,
                    p = l.computed ? T(l.key, t) : l.key.name;
                c.push(p), "Identifier" === (u = l.value).type ? t[n](u.name, o[p]) : V(u, t, {
                    kind: n,
                    feed: o[p]
                })
            } else {
    ...
    function Tr(e, t, r) {
        for (var i = (r = void 0 === r ? {} : r).kind, n = r.hoist, s = void 0 !== n && n, n = r.onlyBlock, a = void 0 !== n && n, n = r.feed, o = void 0 === n ? [] : n, c = [], h = 0; h < e.elements.length; h++) {
            var l, u = e.elements[h];
            u && (s ? !a && "var" !== i || ("Identifier" === u.type ? t[i](u.name, a ? I : "var" === i ? C : void 0) : V(u, t, {
                kind: i,
                hoist: s,
                onlyBlock: a
            })) : "Identifier" === u.type ? i ? t[i](u.name, o[h]) : ((l = wr(u, t, {
                getVar: !0
            })).set(o[h]), c.push(l.get())) : "RestElement" === u.type ? Vr(u, t, {
                kind: i,
                feed: o.slice(h)
            }) : V(u, t, {
                kind: i,
    ...
    function Vr(e, t, r) {
        var i = (r = void 0 === r ? {} : r).kind,
            ...
            r = void 0 === r ? [] : r,
            e = e.argument;
        n ? !s && "var" !== i || ("Identifier" === e.type ? t[i](e.name, s ? I : "var" === i ? C : void 0) : V(e, t, {
            kind: i,
            hoist: n,
            onlyBlock: s
        })) : "Identifier" === e.type ? i ? t[i](e.name, r) : wr(e, t, {
            getVar: !0
        }).set(r) : V(e, t, {
            kind: i,
            feed: r
    ...
    function Nr(e, t, r) {
        ...
        n ? !s && "var" !== i || ("Identifier" === e.type ? t[i](e.name, s ? I : "var" === i ? C : void 0) : V(e, t, {
            ...
            hoist: n,
            onlyBlock: s
        })) : "Identifier" === e.type ? t[i](e.name, r) : V(e, t, {
            kind: i,
            feed: r
        })
    }
    ...
    function T(e, t) {
        if (e) {
            var r = (Rr = Rr || m({}, F, Pr, Sr, M, _r, Br, Dr))[e.type];
            if (r) return r(e, t);
    ...
    function Mr(e, t, r) {
        ...
        for (var a = 0; a < e.body.length; a++) {
            var o = T(e.body[a], s);
            if (o === _) {
                if (o.LABEL && o.LABEL === r.label) break;
                return o
            }
            if (o === k || o === S) return o
        }
    ...
    function Ur(e, t) {
        return S.RES = e.argument ? T(e.argument, t) : void 0, S
    }

    function qr(e) {
        return _.LABEL = null == (e = e.label) ? void 0 : e.name, _
    }

    function Wr(e) {
        return k.LABEL = null == (e = e.label) ? void 0 : e.name, k
    }

    function Gr(e, t) {
        var r = e.label.name;
        if ("WhileStatement" === e.body.type) return Jr(e.body, t, {
            label: r
        });
        if ("DoWhileStatement" === e.body.type) return $r(e.body, t, {
            label: r
        });
        if ("ForStatement" === e.body.type) return ei(e.body, t, {
            label: r
        });
        if ("ForInStatement" === e.body.type) return ti(e.body, t, {
            label: r
        });
        if ("ForOfStatement" === e.body.type) return ri(e.body, t, {
            label: r
        });
        if ("BlockStatement" === e.body.type) return Mr(e.body, t, {
            label: r
        });
        if ("WithStatement" === e.body.type) return Hr(e.body, t, {
            label: r
        });
        if ("IfStatement" === e.body.type) return zr(e.body, t, {
            label: r
        });
        if ("SwitchStatement" === e.body.type) return Kr(e.body, t, {
            label: r
        });
        if ("TryStatement" === e.body.type) return Yr(e.body, t, {
            label: r
        });
    ...
    function Hr(e, t, r) {
        void 0 === r && (r = {});
        var i = new P(t),
            t = (i.with(T(e.object, t)), T(e.body, i));
        return t === _ ? t.LABEL && t.LABEL === r.label ? void 0 : t : t === k || t === S ? t : void 0
    }

    function zr(e, t, r) {
        return void 0 === r && (r = {}), (e = T(e.test, t) ? T(e.consequent, t) : T(e.alternate, t)) === _ ? e.LABEL && e.LABEL === r.label ? void 0 : e : e === k || e === S ? e : void 0
    }

    function Kr(e, t, r) {
        void 0 === r && (r = {});
        for (var i = T(e.discriminant, t), n = !1, s = 0; s < e.cases.length; s++) {
            var a = e.cases[s];
            if (n = n || a.test && T(a.test, t) !== i ? n : !0) {
                a = Qr(a, t);
                if (a === _) {
    ...
    function Yr(t, r, e) {
        ...
        try {
            ...
            if (!t.handler) throw e;
            var n, s = new P(r),
                a = t.handler.param;
            a && ("Identifier" === a.type ? (n = a.name, s.var(n, e)) : V(a, r, {
                feed: e
            })), i = Zr(t.handler, s)
        } finally {
            t.finalizer && (i = Mr(t.finalizer, r))
        }
        return i === _ ? i.LABEL && i.LABEL === e.label ? void 0 : i : i === k || i === S ? i : void 0
    }
    ...
    function Jr(e, t, r) {
        for (void 0 === r && (r = {}); T(e.test, t);) {
            ...
            if (i === k) {
                if (i.LABEL !== r.label) return i
            } else if (i === S) return i
        }
    }
    ...
    function ei(e, t, r) {
        void 0 === r && (r = {});
        var i = new P(t);
        for (T(e.init, i); !e.test || T(e.test, i); T(e.update, i)) {
            var n = new P(i),
                s = void 0;
            if ((s = "BlockStatement" === e.body.type ? Mr(e.body, n, {
                    invasived: !0
                }) : T(e.body, n)) === _) {
            ...
            if (s === k) {
                if (s.LABEL !== r.label) return s
            } else if (s === S) return s
        }
    }

    function ti(e, t, r) {
        for (var i in void 0 === r && (r = {}), T(e.right, t)) {
            i = gi(e, t, {
                value: i
            });
            if (i === _) {
    ...
    function ri(e, t, r) {
        void 0 === r && (r = {});
        var i, n, s = T(e.right, t);
        try {
            for (var a = b(s), o = a.next(); !o.done; o = a.next()) {
                var c = gi(e, t, {
                    value: o.value
                });
                if (c === _) {
                    if (c.LABEL === r.label) break;
                    return c
                }
                if (c === k) {
                    if (c.LABEL !== r.label) return c
    ...
    function ii(e, t) {
        t.func(e.id.name, N(e, t))
    }

    function ni(e, t, r) {
        void 0 === r && (r = {});
        for (var i = 0; i < e.declarations.length; i++) si(e.declarations[i], t, m({
            kind: e.kind
        }, r))
    }
    ...
    function si(e, t, r) {
        var i = (r = void 0 === r ? {} : r).kind,
            ...
            s = void 0 !== s && s,
            a = r.feed;
        n ? !s && "var" !== i || ("Identifier" === e.id.type ? t[i](e.id.name, s ? I : "var" === i ? C : void 0) : V(e.id, t, {
            kind: i,
            hoist: n,
            onlyBlock: s
        })) : (s = (n = "feed" in r) ? a : T(e.init, t), "Identifier" === e.id.type ? (r = e.id.name, "var" !== i || e.init || n ? t[i](r, s) : t.var(r, C), e.init && -1 !== ["ClassExpression", "FunctionExpression", "ArrowFunctionExpression"].indexOf(e.init.type) && !s.name && f(s, "name", {
            value: r,
            configurable: !0
        })) : V(e.id, t, {
            kind: i,
    ...
    function ai(e, t) {
        t.func(e.id.name, yi(e, t))
    }

    function oi(e, t, r) {
        for (var i = (r = void 0 === r ? {} : r).klass, n = r.superClass, s = 0; s < e.body.length; s++) {
            var a = e.body[s];
            "MethodDefinition" === a.type ? ci(a, t, {
                klass: i,
                superClass: n
            }) : "PropertyDefinition" === a.type && a.static ? hi(a, t, {
                klass: i,
                superClass: n
            }) : "StaticBlock" === a.type && li(a, t, {
                klass: i,
                superClass: n
            })
        }
    ...
    function ci(e, t, r) {
        ...
        if (e.computed) i = T(e.key, t);
            ...
            if ("PrivateIdentifier" !== e.key.type) throw new SyntaxError("Unexpected token");
            i = e.key.name, s = !0
        }
    ...
    function hi(e, t, r) {
        ...
        t = new P(t, !0), t.const("this", n);
        s && (n[E] || f(n, E, {
            value: {}
        }), n = n[E]), e.value ? "FunctionExpression" === e.value.type || "ArrowFunctionExpression" === e.value.type ? n[i] = N(e.value, t, {
            superClass: r
        }) : n[i] = T(e.value, t) : n[i] = void 0
    }

    function li(e, t, r) {
        r = (r = void 0 === r ? {} : r).klass, t = new P(t, !0);
        return t.const("this", r), Mr(e, t, {
            invasived: !0
        })
    }

    function ui(e, t) {
        var r, i = t.global().find(xt + e.source.value);
        if (i && (i = i.get()) && ("function" == typeof i ? r = i() : "object" == typeof i && (r = i)), !r || "object" != typeof r) throw new TypeError('Failed to resolve module specifier "' + e.source.value + '"');
        for (var n = 0; n < e.specifiers.length; n++) {
            var s = e.specifiers[n],
                a = void 0;
            if ("ImportSpecifier" === s.type ? a = "Identifier" === s.imported.type ? s.imported.name : s.imported.value : "ImportDefaultSpecifier" === s.type ? a = "default" : "ImportNamespaceSpecifier" === s.type && (a = "*"), "*" !== a && !G(r, a)) throw new SyntaxError('The requested module "' + e.source.value + '" does not provide an export named "' + a + '"');
    ...
    function pi(e, t) {
        var r, i = t.global(),
            e = ("FunctionDeclaration" === e.declaration.type ? (r = N(e.declaration, t), t.func(e.declaration.id.name, r)) : "ClassDeclaration" === e.declaration.type ? (r = yi(e.declaration, t), t.func(e.declaration.id.name, r)) : r = T(e.declaration, t), i.find(A));
    ...
    function di(e, t) {
        ...
        if (e.declaration) {
            if ("FunctionDeclaration" === e.declaration.type) {
                var i = N(e.declaration, t);
                t.func(e.declaration.id.name, i), (n = r.find(A)) && (s = n.get()) && "object" == typeof s && (s[e.declaration.id.name] = i)
            } else if ("ClassDeclaration" === e.declaration.type) {
                var n, s, i = yi(e.declaration, t);
                t.func(e.declaration.id.name, i), (n = r.find(A)) && (s = n.get()) && "object" == typeof s && (s[e.declaration.id.name] = i)
            } else if ("VariableDeclaration" === e.declaration.type)
                if (ni(e.declaration, t), n = r.find(A)) {
                    var a = n.get();
                    if (a && "object" == typeof a)
                        for (var o = 0; o < e.declaration.declarations.length; o++) {
                            var c = e.declaration.declarations[o].id.name;
                            (l = t.find(c)) && (a[c] = l.get())
                        }
                }
            ...
            if (n = r.find(A)) {
                ...
                if (h && "object" == typeof h)
                    for (o = 0; o < e.specifiers.length; o++) {
                        var l, u = e.specifiers[o],
                            p = "Identifier" === u.local.type ? u.local.name : u.local.value;
                        (l = t.find(p)) && (h["Identifier" === u.exported.type ? u.exported.name : u.exported.value] = l.get())
                    }
            }
    }
    ...
    function mi(e, t, r) {
        for (var r = (r = void 0 === r ? {} : r).onlyBlock, i = void 0 !== r && r, n = [], s = [], a = 0; a < e.body.length; a++) {
            var o = e.body[a];
            "FunctionDeclaration" === o.type ? (n.push(o), s.push(a)) : "VariableDeclaration" === o.type && -1 !== ["const", "let"].indexOf(o.kind) ? ni(o, t, {
                hoist: !0,
                onlyBlock: !0
            }) : i || function e(t, r) {
                switch (t.type) {
                    ...
                    case "ForInStatement":
                    case "ForOfStatement":
                        "VariableDeclaration" === t.left.type && ni(t.left, r, {
                            hoist: !0
                        });
                    case "ForStatement":
                        "ForStatement" === t.type && "VariableDeclaration" === t.init.type && ni(t.init, r, {
                            hoist: !0
                        });
                    case "WhileStatement":
    ...
    function N(c, h, e) {
        var t, l, u, p, r;
        return void 0 === e && (e = {}), c.generator || c.async ? R(c, h, e) : (l = e.superClass, u = e.construct, p = c.params, e = function e() {
            for (var t = this && this instanceof e ? this.constructor : void 0, r = [], i = 0; i < arguments.length; i++) r[i] = arguments[i];
            var n = new P(h, !0);
            "ArrowFunctionExpression" !== c.type && (n.let("this", this), n.let("arguments", arguments), n.const(bt, t), l ? (n.const(mt, l), u && n.let(yt, u)) : u && u(this));
            for (var s, a = 0; a < p.length; a++) {
                var o = p[a];
                "Identifier" === o.type ? n.var(o.name, r[a]) : "RestElement" === o.type ? Vr(o, n, {
                    kind: "var",
                    feed: r.slice(a)
                }) : V(o, n, {
                    kind: "var",
            ...
            return "BlockStatement" === c.body.type ? (mi(c.body, n), s = Mr(c.body, n, {
                invasived: !0,
                hoisted: !0
            })) : (s = T(c.body, n), "ArrowFunctionExpression" === c.type && (S.RES = s, s = S)), s === S ? s.RES : t ? n.find("this").get() : void 0
        }, "ArrowFunctionExpression" === c.type && f(e, gt, {
            value: !0
        }), f(e, "name", {
    ...
    function yi(e, i) {
        for (var n = T(e.superClass, i), s = e.body.body, t = function(e) {
                for (var t = 0; t < s.length; t++) {
                    var r = s[t];
                    "PropertyDefinition" !== r.type || r.static || hi(r, i, {
                        klass: e,
                        superClass: n
                    })
                }
            }, r = function() {
                var e = n ? te(this, n) : this;
                return t(e), e
            }, a = 0; a < s.length; a++) {
            var o = s[a];
    ...
    function gi(e, t, r) {
        var r = r.value,
            i = e.left,
            n = new P(t);
        return "VariableDeclaration" === i.type ? ni(i, n, {
            feed: r
        }) : "Identifier" === i.type ? wr(i, t, {
            getVar: !0
        }).set(r) : V(i, t, {
            feed: r
        }), "BlockStatement" === e.body.type ? Mr(e.body, n, {
            invasived: !0
        }) : T(e.body, n)
    }
    ...
    function vi(t, r, i) {
        ...
        return void 0 === i && (i = {}), v(this, function(e) {
            switch (e.label) {
                ...
                case 2:
                    return "VariableDeclaration" !== o.type || -1 === ["const", "let"].indexOf(o.kind) ? [3, 4] : [5, b(lr(o, r, {
                        hoist: !0,
                        onlyBlock: !0
                    }))];
                case 3:
                    return e.sent(), [3, 6];
                case 4:
                    return n ? [3, 6] : [5, b(function t(r, i) {
                        var n, s, a, o, c;
                        return v(this, function(e) {
                            switch (e.label) {
                                case 0:
                                ...
                                case 2:
                                    return e.sent(), [3, 38];
                                case 3:
                                    return "VariableDeclaration" !== r.left.type ? [3, 5] : [5, b(lr(r.left, i, {
                                        hoist: !0
                                    }))];
                                case 4:
                                    e.sent(), e.label = 5;
                                case 5:
                                    return "ForStatement" !== r.type || "VariableDeclaration" !== r.init.type ? [3, 7] : [5, b(lr(r.init, i, {
                                        hoist: !0
                                    }))];
                                case 6:
                                    e.sent(), e.label = 7;
    ...
    function R(c, h, e) {
        var t, l, u, p, s, r, i;
        return void 0 === e && (e = {}), c.generator || c.async ? (l = e.superClass, u = e.construct, p = c.params, s = function e() {
            for (var t, r, i, n, s = this && this instanceof e ? this.constructor : void 0, a = [], o = 0; o < arguments.length; o++) a[o] = arguments[o];
            return v(this, function(e) {
                switch (e.label) {
                    case 0:
                        if (t = new P(h, !0), "ArrowFunctionExpression" !== c.type) {
                            if (t.let("this", this), t.let("arguments", arguments), t.const(bt, s), !l) return [3, 1];
                            t.const(mt, l), u && t.let(yt, u)
                        }
                        return [3, 3];
                    case 1:
                        return u ? [5, b(u(this))] : [3, 3];
                    case 2:
                        e.sent(), e.label = 3;
                    case 3:
                        r = 0, e.label = 4;
                    ...
                    case 5:
                        return "RestElement" !== i.type ? [3, 7] : [5, b(Mt(i, t, {
                            kind: "var",
                            feed: a.slice(r)
                        }))];
                    case 6:
                    ...
                    case 13:
                        return [5, b(L(c.body, t))];
                    case 14:
                        n = e.sent(), "ArrowFunctionExpression" === c.type && (S.RES = n, n = S), e.label = 15;
                    case 15:
                        return n === S ? [2, n.RES] : s ? [2, t.find("this").get()] : [2]
                }
            })
        }, r = c.async && c.generator ? function() {
            function t(e) {
            ...
            return Ct(s.apply(this, arguments))
        } : s, f(r, gt, {
            value: !0
        }), f(r, "name", {
            value: c.id && c.id.name || "",
    ...
    function bi(t, n) {
        ...
        return v(this, function(e) {
            switch (e.label) {
                case 0:
                    return [5, b(L(t.superClass, n))];
                case 1:
                    for (s = e.sent(), a = t.body.body, r = function(t) {
                            var r, i;
                            return v(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        r = 0, e.label = 1;
                                    case 1:
                                        return r < a.length ? "PropertyDefinition" !== (i = a[r]).type || i.static ? [3, 3] : [5, b(mr(i, n, {
                                            klass: t,
                                            superClass: s
                                        }))] : [3, 4];
                                    case 2:
                            ...
                            return v(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return t = s ? te(this, s) : this, [5, b(r(t))];
                                    case 1:
                                        return e.sent(), [2, t]
                                }
                            })
                        ...
                        if ("MethodDefinition" === (c = a[o]).type && "constructor" === c.kind) {
                            ...
                            break
                        } return s && ee(i, s), [5, b(dr(t.body, n, {
                        klass: i,
                        superClass: s
                    }))];
                case 2:
                    return e.sent(), f(i, vt, {
                        value: !0
                    }), f(i, "name", {
    ...
    function xi(t, r, i) {
        ...
        return v(this, function(e) {
            switch (e.label) {
                case 0:
                    return n = i.value, s = t.left, a = new P(r), "VariableDeclaration" !== s.type ? [3, 2] : [5, b(lr(s, a, {
                        feed: n
                    }))];
                case 1:
                    return e.sent(), [3, 6];
                case 2:
                    return "Identifier" !== s.type ? [3, 4] : [5, b(wr(s, r, {
                        getVar: !0
                    }))];
                case 3:
                ...
                case 5:
                    e.sent(), e.label = 6;
                case 6:
                    return "BlockStatement" !== t.body.type ? [3, 8] : [5, b(Gt(t.body, a, {
                        invasived: !0
                    }))];
                case 7:
    ...
    function wi(e) {
        void 0 === e && (e = {}), this.options = {
            ecmaVersion: "latest"
        }, this.scope = new P(null, !0), this.exports = {};
        var t = e.ecmaVer,
            t = void 0 === t ? "latest" : t,
            r = e.sandBox,
            r = void 0 === r || r,
